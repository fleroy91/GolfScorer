...
- (void)findOrCreateHolesInDB
{
    ...
    for(NSString *strJson in strJsons) {
        ...
        if(! course) {
            ...
            course.slope1M = [json objectForKey:@"splope1M"];
            course.slope2M = [json objectForKey:@"splope2M"];
            course.slope3M = [json objectForKey:@"splope3M"];
            course.slope4M = [json objectForKey:@"splope4M"];
            course.slope5M = [json objectForKey:@"splope5M"];
            ...
            course.slope1F = [json objectForKey:@"splope1F"];
            course.slope2F = [json objectForKey:@"splope2F"];
            course.slope3F = [json objectForKey:@"splope3F"];
            course.slope4F = [json objectForKey:@"splope4F"];
            course.slope5F = [json objectForKey:@"splope5F"];

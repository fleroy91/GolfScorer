...
{   
    ...
    EXTDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"EXTDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(EXTDataViewController *)viewController];
